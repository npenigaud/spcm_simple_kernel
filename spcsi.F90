...
CALL cublasDgemm('N','N',YDGEOMETRY%YRDIMV%NFLEVG,ISPCOL,YDGEOMETRY%YRDIMV%NFLEVG,1.0,YDDYN%SIMI,YDGEOMETRY%YRDIMV%NFLEVG,ZSDIV,YDGEOMETRY%YRDIMV%NFLEVG,0.0,ZSDIVP(:,KSTA:KEND),YDGEOMETRY%YRDIMV%NFLEVG)
!$acc end host_data
!!!$acc end data
